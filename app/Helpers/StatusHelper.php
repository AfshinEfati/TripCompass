...
class StatusHelper
{
    public static function getStatus($status): array
    {
        return $status ? [
            'name' => 'active',
            'fa_name' => 'فعال',
    ...
    public static function successResponse($data, $message): JsonResponse
    {
    ...
    public static function unauthorizedResponse(array $array, string $string): JsonResponse
    {
        return response()->json([
            'success' => false,
            'message' => $string,
    ...
    public static function notFoundResponse($data, $message): JsonResponse
    {
        return response()->json([
            'success' => false,
            'data' => $data,
    ...
    public static function formatDates($date): array
    {
